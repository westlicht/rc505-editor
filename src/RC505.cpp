...
IntProperty::Type IntProperty::RateType(
    ...
    [] (float f) { 
        ...
        case 107: return String("Quarter Note");
        case 108: return String("Dottet Eighth Note");
        case 109: return String("Quarter Note Triplet");
        case 110: return String("Eighth Note");
        case 111: return String("Dotted Sixteenth Note");
...
IntProperty::Type IntProperty::StepRateType(
    ...
    [] (float f) { 
        ...
        case 102: return String("4 Measures");
        case 103: return String("2 Measures");
        case 104: return String("1 Measures");
        case 105: return String("Half Note");
        case 106: return String("Dotted Quarter Note");
        case 107: return String("Half Note Triplet");
        case 108: return String("Quarter Note");
        case 109: return String("Dottet Eighth Note");
        case 110: return String("Quarter Note Triplet");
        case 111: return String("Eighth Note");
        case 112: return String("Dotted Sixteenth Note");
        case 113: return String("Eighth Note Triplet");
        case 114: return String("Sixteenth Note");
        case 115: return String("Thirty-second Note");
        default: return String(i);
        }
    },
    0.f,
...
IntProperty::Type IntProperty::DelayTimeType(
    ...
    [] (float f) { 
        ...
        case 1004: return String("Dotted Sixteenth Note");
        case 1005: return String("Eighth Note");
        case 1006: return String("Quarter Note Triplet");
        case 1007: return String("Dottet Eighth Note");
        case 1008: return String("Quarter Note");
